NODE 1
------
etcd --name infra1 --data-dir=/var/lib/etcd/mycluster.etcd \
  --initial-advertise-peer-urls http://10.217.211.130:2380 \
...
NODE 2
------
etcd --name infra2 --data-dir=/var/lib/etcd/mycluster.etcd \
  --initial-advertise-peer-urls http://10.221.50.14:2380 \
...
NODE 3
------
etcd --name infra3 --data-dir=/var/lib/etcd/mycluster.etcd \
  --initial-advertise-peer-urls http://10.217.202.140:2380 \
